 ...
 */
 export function clampSliderValue(type: Partial<SliderType>, value: number) {
 ...
 */
export function getSliderValueFromInputField(props: Partial<SliderOptions>, e: KeyboardEvent) {
 ...
 */
 export function getSliderValueFromClipboard(props: Partial<SliderOptions>, e: ClipboardEvent) {
